...
public class CanonicalRequestTranslator implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        if (!isValid) {
            ...
            canonicalJson.put("reason", "Mensaje incompleto: faltan campos obligatorios para procesarlo");
        ...
        String requestType = originalJson.get("request_type").asText().trim().toUpperCase();
